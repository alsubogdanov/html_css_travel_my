      ...
      <div className='d-flex g2 mb6'>
        {categories.map((cat) => (
          <button
            ...
            className={`cat__btn ${selectedCategory === cat ? 'active' : ''}`}>
            {cat}
          </button>
        ))}
      </div>
      ...
      {currentIndex !== null && (
        <div className='modal' id='myModal' onClick={closeModal}>
          <div className='modal-content'>
            <button className='close-btn mt10' id='closeModalBtn' onClick={closeModal}>
              <img src={close} />
            </button>
            <button className='btn_prev' onClick={showPrev}>
              <img src={left} />
            </button>
            <img
            ...
            <button className='btn__next' onClick={showNext}>
              <img src={right} />
            </button>
          </div>
        </div>
